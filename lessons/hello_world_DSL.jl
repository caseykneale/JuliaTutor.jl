...
prompt_1 =
"""Welcome to your first day of class. Today we'll be doing a classic excercise. We will be learning how to print text to our console. Along the way we'll cover some ways to handle strings in Julia.
Strings are defined by double quotes " " in julia. For example, we could define a variable, called console_output to contain the text "hello world" like the following,
...
prompt_2 = """Congratulations you have instantiated your first variable in Julia! How might we display this text to console? There are two functions that let you do this: print() and println(). Print will display the String or variable as it is, but println will add a new line/carriage return to the end of it.
...
# Notice: we did not provide any hints for this excercise. Not nice, but either they get it, or they don't.
